...
def fix_loader():
    ...
    # Fixed imports and CurrentSignatureLoader class
    imports_code = [
        "import numpy as np\n",
        "import pandas as pd\n",
        ...
        "import glob\n",
        "\n",
        "# CurrentSignatureLoader Class Definition (FIXED)\n",
        ...
        "                        continue\n",
        "                    \n",
        "                    # Take only first 3 columns (3-phase current)\n",
    ...
    for i, cell in enumerate(nb['cells']):
        if cell['cell_type'] == 'code':
            ...
            if "CurrentSignatureLoader" in source or "import numpy" in source:
                print(f"Found the imports cell at index {i}. Updating with fixed loader...")
    ...
    if found:
        ...
        print("Notebook updated successfully with fixed CurrentSignatureLoader.")
    else:
