"""
Update RUL calculation and add comprehensive visualization (including Months/Years)
"""
import json
...
# 1. Update Cell 7 (RUL Calculation)
# ==================================
rul_calc_code = [
    "# ============================================\n",
...
nb['cells'][7]['source'] = rul_calc_code
print("Updated Cell 7: RUL Calculation with time units")


# 2. Insert Visualization Cells (Markdown + Code)
# ===============================================
viz_markdown = {
    "cell_type": "markdown",
    "metadata": {},
...
# Insert after Cell 7
nb['cells'].insert(8, viz_markdown)
nb['cells'].insert(9, viz_code)
print("Inserted visualization cells at index 8 and 9")
...
print("  - Updated RUL calculation to include all time units")
print("  - Added 6 separate plots: Percentage, Hours, Days, Weeks, Months, Years")
