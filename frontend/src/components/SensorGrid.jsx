  ...
  return (
    <section className="panel">
      ...
      <div className="sensor-grid">
        ...
        <SensorCard title="Vibration RMS" value={sensors.vibration.rms.toFixed(3)} unit="g" detail={`Crest ${sensors.vibration.crestFactor.toFixed(2)} | Kurtosis ${sensors.vibration.kurtosis.toFixed(2)}`} freshness={sensors.freshness} tone={sensors.vibration.rms > 2.04 ? 'danger' : sensors.vibration.rms > 0.51 ? 'warning' : 'success'} />
        <SensorCard title="Stator Temperature" value={sensors.temperature.stator.toFixed(1)} unit="°C" detail={`Delta ${sensors.temperature.delta.toFixed(1)} K`} freshness={sensors.freshness} tone={sensors.temperature.stator > 120 ? 'danger' : sensors.temperature.stator > 95 ? 'warning' : 'success'} />
