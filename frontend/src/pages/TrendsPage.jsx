...
const PARAM_META = {
  vibration: {
    ...
    desc:  'Root Mean Square vibration acceleration — ISO 10816-3 Group II (15–300 kW, rigid mount)',
    refNote: 'Zone A (new) <0.51 g  ·  Zone B (acceptable) 0.51–2.04 g  ·  Zone C (alarm) 2.04–3.27 g  ·  Zone D (danger) ≥3.27 g',
  },
  temperature: {
  ...
  current: {
    ...
    unit:  'A',
    color: '#2563eb',
    warnAt: 129, critAt: 148,
    desc:  'Line current (delta connection) — IEC 60034-1  (Rated: 129 A line / 74.5 A phase)',
    refNote: 'Warning at 129 A (>100% rated line)  ·  Critical at 148 A (>115% rated line)',
  },
  rpm: {
    label: 'Rotor Speed',
    unit:  'RPM',
  ...
  torque: {
    ...
    desc:  'Shaft mechanical torque — rated 483.9 N·m at 1480 RPM for 75 kW motor',
    refNote: 'Rated: 483.9 N·m  ·  Warning at 532 N·m (110%)  ·  Critical at 605 N·m (125%)',
  },
  rul: {
  ...
  predictionCertainty: {
    ...
    desc:  'Per-inference softmax certainty of the current health classification. NOT the 90.89% published model accuracy.',
